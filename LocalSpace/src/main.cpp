...
int main() {
	...
	while (window.isOpen()) {
		...
		drawMesh(framebuffer, frustum, cameraPosition, cameraOrientation, position1, orientation1, scale1, cubeVertices, cubeFaces, Pixel{ 255, 0, 0, 255 });
		drawMesh(framebuffer, frustum, cameraPosition, cameraOrientation, position2, orientation2, scale2, cubeVertices, cubeFaces, Pixel{ 0, 255, 0, 255 });
		drawMesh(framebuffer, frustum, cameraPosition, cameraOrientation, position3, orientation3, scale3, cubeVertices, cubeFaces, Pixel{ 0, 0, 255, 255 });
